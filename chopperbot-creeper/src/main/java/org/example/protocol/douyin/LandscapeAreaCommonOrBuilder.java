...
public interface LandscapeAreaCommonOrBuilder extends
    // @@protoc_insertion_point(interface_extends:org.example.protocol.douyin.LandscapeAreaCommon)
   ...
   */
  java.util.List<org.example.protocol.douyin.CommentTypeTag> getCommentTypeTagsListList();
  /**
   * <code>repeated .org.example.protocol.douyin.CommentTypeTag commentTypeTagsList = 5;</code>
   ...
   */
  org.example.protocol.douyin.CommentTypeTag getCommentTypeTagsList(int index);
  /**
   * <code>repeated .org.example.protocol.douyin.CommentTypeTag commentTypeTagsList = 5;</code>
