...
public class DouyinLiveWebSocketClient {
     ...
     * 连接抖音直播间WebSocket服务器
     */
    public void connectWebSocket(String roomId) throws Exception {
        // 构建WebSocket URL
        ...
        String wss = "wss://webcast100-ws-web-lf.douyin.com/webcast/im/push/v2/?" +
                "app_name=" + appName +
                ...
                "&browser_version=" + encodedBrowserVersion +
                "&browser_online=true" +
                "&tz_name=" + encodedTzName +
                "&cursor=d-1_u-1_fh-7392091211001140287_t-1721106114633_r-1" +
                "&internal_ext=" + encodedInternalExt +
                "&host=" + encodedHost +
                "&aid=" + aid +
                "&live_id=" + liveId +
                "&did_rule=" + didRule +
